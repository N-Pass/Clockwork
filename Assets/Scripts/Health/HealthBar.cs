...
public class HealthBar : MonoBehaviour
{
    ...
    private const string SEPARATOR_CONTAINER = "SeparatorContainer";
    ...
    private void Start()
    {
        separatorContainer = transform.Find(SEPARATOR_CONTAINER);
    ...
    {
        Transform separatorTemplate = separatorContainer.Find(SEPARATOR_TEMPLATE);
